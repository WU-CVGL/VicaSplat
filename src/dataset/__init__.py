...
from .dataset_re10k import DatasetRE10k, DatasetRE10kCfg, DatasetRE10kCfgWrapper, DatasetDL3DVCfgWrapper, \
    DatasetScannetppCfgWrapper, DatasetMVImgNetCfgWrapper
...
DATASETS: dict[str, Dataset] = {
    ...
    "mvimgnet": DatasetRE10k,
    "scannet": DatasetScannet
}


DatasetCfgWrapper = DatasetRE10kCfgWrapper | DatasetDL3DVCfgWrapper | DatasetScannetppCfgWrapper | DatasetScannetPoseCfgWrapper | DatasetMVImgNetCfgWrapper | DatasetScannetCfgWrapper
